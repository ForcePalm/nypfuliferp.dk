...
class SettingsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->notEmptyString('site_logo');

        $validator
            ->scalar('theme_primary_color')
            ->maxLength('theme_primary_color', 255)
            ->notEmptyString('theme_primary_color');

        $validator
            ->scalar('theme_secondary_color')
            ->maxLength('theme_secondary_color', 255)
            ->notEmptyString('theme_secondary_color');
